...
> Cross-phase tasks only — phase-local tasks live in each phase's `plan.md`. Before marking `[x]`, cite fresh evidence (see [`.agents/skills/ship-it/references/evidence.md`](../../../../../.agents/skills/ship-it/references/evidence.md)).
