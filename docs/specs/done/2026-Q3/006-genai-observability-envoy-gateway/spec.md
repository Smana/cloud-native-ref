...
- Observability rules: [observability/AGENTS.md](../../../../../observability/AGENTS.md) — `$${var}` dashboard escaping, logs datasource
- CNP rules: [security/AGENTS.md](../../../../../security/AGENTS.md) — scrape-ingress on default-deny
