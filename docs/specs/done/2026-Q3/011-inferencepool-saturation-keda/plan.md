...
> Each task has a stable ID. Cite fresh evidence before marking `[x]` (see [.agents/skills/ship-it/references/evidence.md](../../../../../.agents/skills/ship-it/references/evidence.md)).
