...
- **Fixed values used throughout** (do not invent alternatives):
  ...
  | Snapshot image | `ghcr.io/smana/openbao-snapshot:0.2.0` |
...
ARG OPENBAO_SNAPSHOT_VERSION=0.2.0
```
...
Change `image: ghcr.io/smana/openbao-snapshot:v0.1.0` to `image: ghcr.io/smana/openbao-snapshot:0.2.0`.
