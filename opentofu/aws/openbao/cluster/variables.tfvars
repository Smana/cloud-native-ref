...
leader_tls_servername = "bao.priv.aws.ogenki.io" # Vault domain name that will be exposed to users
domain_name           = "priv.aws.ogenki.io"     # Route53 private zone where to provision the DNS records
...
enable_ssm                       = true
openbao_certificates_secret_name = "certificates/priv.aws.ogenki.io/openbao" # The name of the AWS Secrets Manager secret containing the OpenBao certificates
