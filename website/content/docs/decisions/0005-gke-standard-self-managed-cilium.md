...
- Current Cilium docs carry a working GKE recipe for exactly the pinned version (1.20.2) — see
  References.
...
- [Cilium GKE-to-GKE Clustermesh Preparation](https://docs.cilium.io/en/latest/network/clustermesh/gke-clustermesh-prep/) — current docs, working GKE + Cilium 1.20.2 recipe
