...
- **Cloud-agnostic public names.** [ADR-0017]({{< relref "/docs/decisions/0017-multi-cloud-dns-naming.md" >}}) already
...
- **One Gateway implementation per cluster**, consistent with
  [ADR-0005]({{< relref "/docs/decisions/0005-gke-standard-self-managed-cilium.md" >}})'s reasoning against a second
...
[ADR-0017]({{< relref "/docs/decisions/0017-multi-cloud-dns-naming.md" >}}) rejects exactly that: *"A public endpoint has no
...
- Stack: `opentofu/shared/aws-gcp-federation/` — `aws_iam_openid_connect_provider.gke`,
  ...
  [ADR-0018]({{< relref "/docs/decisions/0018-per-cloud-opentofu-state.md" >}}) for why `shared/` stays in S3 while the GCP
  tree moved to GCS).
