...
{{< cards >}}
  ...
  {{< card link="/docs/platform/ai-platform/" title="AI Platform" icon="sparkles" subtitle="An opt-in vLLM serving platform behind Envoy AI Gateway — off by default until two independent gates are both released." >}}
{{< /cards >}}
