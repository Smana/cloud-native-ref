...
The directory is a complete, "external-everything" OnCall install per
[Grafana's scalable Helm guide](https://grafana.com/docs/grafana-oncall/latest/setup/install/helm/install-scalable/):
