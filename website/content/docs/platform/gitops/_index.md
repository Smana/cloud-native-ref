...
|---|---|---|
| `FluxInstance` | The Flux Operator manages Flux's own installation and upgrades from this one object — which controllers run, how they are sharded, how they are tuned | `opentofu/eks/init/helm_values/flux-instance.yaml`, applied in Stage 2 |
